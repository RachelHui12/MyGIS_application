...
namespace MyGIS_xsp
{
    ...
    {
        public SpatialQuery(AxMapControl mapControl)
        {
            InitializeComponent();
            this.mMapControl = mapControl;
            this.label1.Text = "select features from one or more target layers based \non their location in relation to the features in the \nsource layer.";
